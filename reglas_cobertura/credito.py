...
# Lo mismo en test que en valid: al final he decido no hacer los cambios aqui
# marcados,para que haya mayor rendimiento. Así que estos son todos ejemplos
# generados directamente a partir del árbol de partida.
